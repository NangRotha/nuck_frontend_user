...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍន៍ជនបទ' : 'Rural Development' ?> | Faculty of Social Science - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Rural Development Program -->
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍន៍ជនបទ' : 'Rural Development' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Rural Development' : 'អភិវឌ្ឍន៍ជនបទ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកអភិវឌ្ឍន៍ជនបទ' : 'Bachelor of Science in Rural Development Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកអភិវឌ្ឍន៍ជនបទ ត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹង និងជំនាញដល់និស្សិតដើម្បីជំរុញការអភិវឌ្ឍន៍ប្រកបដោយនិរន្តរភាព កែលម្អជីវភាព និងពង្រឹងសហគមន៍ជនបទតាមរយៈវិធីសាស្ត្រច្នៃប្រឌិត និងរួមបញ្ចូល។' : 'The Bachelor of Science in Rural Development program aims to equip students with the knowledge and skills to promote sustainable development, improve livelihoods, and empower rural communities through innovative and inclusive approaches.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើការអភិវឌ្ឍន៍សហគមន៍ ការគ្រប់គ្រងធនធានធម្មជាតិ និងយុទ្ធសាស្ត្រកាត់បន្ថយភាពក្រីក្រក្នុងតំបន់ជនបទ។' : 'This program focuses on community development, natural resource management, and poverty reduction strategies in rural areas.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលការណ៍អភិវឌ្ឍន៍ជនបទប្រកបដោយនិរន្តរភាព' : 'Understand principles of sustainable rural development' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តយុទ្ធសាស្ត្រអភិវឌ្ឍន៍ផ្អែកលើសហគមន៍' : 'Apply community-based development strategies' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគ និងដោះស្រាយបញ្ហាអភិវឌ្ឍន៍ជនបទ' : 'Analyze and address rural development challenges' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍដំណោះស្រាយច្នៃប្រឌិតសម្រាប់សហគមន៍ជនបទ' : 'Develop innovative solutions for rural communities' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយសហគមន៍ និងភាគីពាក់ព័ន្ធក្នុងតំបន់' : 'Collaborate with local communities and stakeholders' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងផែនការអភិវឌ្ឍន៍ប្រកបដោយប្រសិទ្ធភាព' : 'Communicate development plans effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់ឧបករណ៍ផ្អែកលើទិន្នន័យសម្រាប់ការរៀបចំផែនការអភិវឌ្ឍន៍ជនបទ' : 'Use data-driven tools for rural development planning' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តវិធីសាស្ត្រអភិវឌ្ឍន៍ដោយមានការចូលរួម' : 'Implement participatory development approaches' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-tree text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីអភិវឌ្ឍន៍ជនបទ' : 'Rural Development Officer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកជំនាញអភិវឌ្ឍន៍សហគមន៍' : 'Community Development Specialist' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-project-diagram text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងគម្រោងអភិវឌ្ឍន៍ជនបទ' : 'Project Manager for Rural Programs' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីផ្សព្វផ្សាយកសិកម្ម' : 'Agricultural Extension Officer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវផ្នែកអភិវឌ្ឍន៍ជនបទ' : 'Researcher in Rural Development' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាគោលនយោបាយផ្នែកជនបទ' : 'Policy Advisor for Rural Affairs' ?></p>
              </div>
            </div>
          </div>
        </section>
