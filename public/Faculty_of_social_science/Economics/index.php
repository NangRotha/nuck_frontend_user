...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'សេដ្ឋកិច្ច' : 'Economics' ?> | Faculty of Social Science - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Economics Program -->
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          ...
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Economics' : 'សេដ្ឋកិច្ច' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រផ្នែកសេដ្ឋកិច្ច' : 'Bachelor of Economics Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រផ្នែកសេដ្ឋកិច្ច ត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹងជ្រៅជ្រះអំពីទ្រឹស្តីសេដ្ឋកិច្ច ជំនាញវិភាគ និងសមត្ថភាពអនុវត្តគោលការណ៍សេដ្ឋកិច្ចដើម្បីដោះស្រាយបញ្ហាជីវិតពិត ជំរុញការអភិវឌ្ឍន៍ប្រកបដោយនិរន្តរភាព និងការសម្រេចចិត្តដោយយល់ដឹង។' : 'The Bachelor of Economics program aims to equip students with a deep understanding of economic theories, analytical skills, and the ability to apply economic principles to solve real-world problems, fostering sustainable development and informed decision-making.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើមីក្រូសេដ្ឋកិច្ច ម៉ាក្រូសេដ្ឋកិច្ច សេដ្ឋកិច្ចអភិវឌ្ឍន៍ និងសេដ្ឋកិច្ចអន្តរជាតិ។' : 'This program focuses on microeconomics, macroeconomics, development economics, and international economics.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីទ្រឹស្តី និងគំរូសេដ្ឋកិច្ច' : 'Understand economic theories and models' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តគោលការណ៍សេដ្ឋកិច្ចក្នុងស្ថានភាពជាក់ស្តែង' : 'Apply economic principles to real-world scenarios' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគទិន្នន័យ និងគន្លឹះសេដ្ឋកិច្ច' : 'Analyze economic data and trends' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍដំណោះស្រាយចំពោះបញ្ហាសេដ្ឋកិច្ច' : 'Develop solutions for economic challenges' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយភាគីពាក់ព័ន្ធក្នុងគម្រោងសេដ្ឋកិច្ច' : 'Collaborate with stakeholders in economic projects' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងការយល់ដឹងផ្នែកសេដ្ឋកិច្ចប្រកបដោយប្រសិទ្ធភាព' : 'Communicate economic insights effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់ឧបករណ៍ស្ថិតិ និងសេដ្ឋមេត្រីសម្រាប់ការវិភាគ' : 'Use statistical and econometric tools for analysis' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តបច្ចេកទេសគំរូសេដ្ឋកិច្ច និងការព្យាករណ៍' : 'Implement economic modeling and forecasting techniques' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកសេដ្ឋកិច្ច' : 'Economist' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិភាគការស្រាវជ្រាវទីផ្សារ' : 'Market Research Analyst' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាសេដ្ឋកិច្ច' : 'Economic Consultant' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវផ្នែកសេដ្ឋកិច្ច' : 'Researcher in Economics' ?></p>
              </div>
            </div>
          </div>
        </section>
