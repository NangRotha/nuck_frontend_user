...
<head>
  ...
  <title>NUCK | <?= $t('faculty_social_science') ?> - National University of Cheasim Kamchaymear</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
        ...
        <div class="nav-menu-desktop">
          ...
          <div class="dropdown-container">
            ...
            <div class="dropdown-menu">
              ...
              <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="dropdown-item"><?= $t('faculty_social_science') ?></a>
    ...
    <div class="space-y-1">
      ...
      <div class="mobile-nav-item">
        ...
        <div class="mobile-dropdown-content" id="academics">
          ...
          <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="mobile-dropdown-item"><?= $t('faculty_social_science') ?></a>
  ...
  <!-- Faculty Header -->
  <div class="faculty-header" style="background-image: url('./../../images/ademices/Development.jpg');">
    ...
    <div class="faculty-title-wrapper">
      <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 faculty-title">
        <?= $t('faculty_social_science') ?>
      </h1>
      <!-- <h2 class="text-xl md:text-2xl lg:text-3xl font-medium mb-4 faculty-title">
        <?= $lang->getCurrentLang() === 'km' ? 'មហាវិទ្យាល័យវិទ្យាសាស្ត្រសង្គម' : 'Faculty of Social Science' ?>
      </h2> -->
  ...
  <div class="container-custom py-12">
    <!-- Public Administrations Card -->
    <div class="program-card">
      <h2 class="program-title">
        <?= $lang->getCurrentLang() === 'km' ? 'រដ្ឋបាលសាធារណៈ' : 'Public Administrations' ?>
      </h2>
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'រដ្ឋបាលសាធារណៈផ្តោតលើការអនុវត្តន៍គោលនយោបាយរដ្ឋាភិបាល និងការគ្រប់គ្រងកម្មវិធីសាធារណៈ។ និស្សិតរៀនអំពីការគ្រប់គ្រង ការវិភាគគោលនយោបាយសាធារណៈ និងដំណើរការរដ្ឋបាល ដើម្បីត្រៀមខ្លួនសម្រាប់អាជីពក្នុងសេវាសាធារណៈ។' : 'Public Administration focuses on the implementation of government policies and the management of public programs. Students learn about governance, public policy analysis, and administrative processes to prepare for careers in public service.' ?>
      </p>
      <a href="./Public_Administrations/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> <i class="fas fa-arrow-right ml-2"></i>
      </a>
    </div>
    ...
    <div class="program-card">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីច្បាប់ផ្តល់ឱ្យនូវការយល់ដឹងច្បាស់លាស់អំពីគោលការណ៍ច្បាប់ ដំណើរការតុលាការ និងតួនាទីរបស់ច្បាប់ក្នុងសង្គម។ និស្សិតសិក្សាអំពីច្បាប់រដ្ឋប្បវេណី ច្បាប់ព្រហ្មទណ្ឌ និងច្បាប់រដ្ឋធម្មនុញ្ញ ដើម្បីត្រៀមខ្លួនសម្រាប់អាជីពក្នុងការអនុវត្តច្បាប់ តុលាការ និងគោលនយោបាយសាធារណៈ។' : 'The Law program provides a comprehensive understanding of legal principles, judicial processes, and the role of law in society. Students study civil, criminal, and constitutional law, preparing them for careers in legal practice, judiciary, and public policy.' ?>
      </p>
      <a href="./Law/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> <i class="fas fa-arrow-right ml-2"></i>
      </a>
    </div>
    ...
    <div class="program-card">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍន៍ជនបទផ្តោតលើការកែលម្អគុណភាពជីវិត និងសុខុមាលភាពសេដ្ឋកិច្ចរបស់ប្រជាជននៅតំបន់ជនបទ។ និស្សិតរៀនអំពីការអភិវឌ្ឍន៍ប្រកបដោយនិរន្តរភាព ការចូលរួមពីសហគមន៍ និងការគ្រប់គ្រងធនធាន ដើម្បីដោះស្រាយបញ្ហាក្នុងសហគមន៍ជនបទ។' : 'Rural Development focuses on improving the quality of life and economic well-being of people in rural areas. Students learn about sustainable development, community engagement, and resource management to address challenges in rural communities.' ?>
      </p>
      <a href="./Rural_Development/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> <i class="fas fa-arrow-right ml-2"></i>
      </a>
    </div>
    ...
    <div class="program-card">
      <h2 class="program-title">
        <?= $lang->getCurrentLang() === 'km' ? 'សេដ្ឋកិច្ច' : 'Economics' ?>
      </h2>
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'សេដ្ឋកិច្ចសិក្សាអំពីការផលិត ការចែកចាយ និងការប្រើប្រាស់ទំនិញ និងសេវាកម្ម។ និស្សិតវិភាគប្រព័ន្ធសេដ្ឋកិច្ច គោលនយោបាយ និងទំនោរសេដ្ឋកិច្ច ដើម្បីយល់ពីរបៀបដែលសង្គមបែងចែកធនធាន និងដោះស្រាយបញ្ហាសេដ្ឋកិច្ច។' : 'Economics studies the production, distribution, and consumption of goods and services. Students analyze economic systems, policies, and trends to understand how societies allocate resources and address economic challenges.' ?>
      </p>
      <a href="./Economics/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> <i class="fas fa-arrow-right ml-2"></i>
      </a>
    </div>
  </div>
