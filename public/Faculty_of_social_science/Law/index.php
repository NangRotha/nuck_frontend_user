...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'និតិសាស្រ្ត (ច្បាប់)' : 'Law' ?> | Faculty of Social Science - NUCK</title>
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'និតិសាស្រ្ត (ច្បាប់)' : 'Law' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Law' : 'និតិសាស្រ្ត (ច្បាប់)' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រផ្នែកច្បាប់' : 'Bachelor of Laws Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រផ្នែកនិតិសាស្ត្រត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹងទូលំទូលាយអំពីគោលការណ៍ច្បាប់ ជំនាញគិតវិភាគ និងសមត្ថភាពអនុវត្តច្បាប់ក្នុងស្ថានភាពជីវិតពិត ដើម្បីជំរុញយុត្តិធម៌ និងការគ្រប់គ្រងដោយច្បាប់។' : 'The Bachelor of Laws program aims to equip students with a comprehensive understanding of legal principles, critical thinking skills, and the ability to apply the law to real-world situations, fostering justice and the rule of law.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើច្បាប់រដ្ឋប្បវេណី ច្បាប់ព្រហ្មទណ្ឌ ច្បាប់រដ្ឋធម្មនុញ្ញ និងច្បាប់ពាណិជ្ជកម្ម។' : 'This program focuses on civil law, criminal law, constitutional law, and commercial law.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលការណ៍ និងប្រព័ន្ធច្បាប់មូលដ្ឋាន' : 'Understand fundamental legal principles and systems' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តទ្រឹស្តីច្បាប់ក្នុងស្ថានភាពជាក់ស្តែង' : 'Apply legal theories to practical scenarios' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគ និងបកស្រាយឯកសារច្បាប់' : 'Analyze and interpret legal documents' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍហេតុផល និងការវែកញែកផ្នែកច្បាប់' : 'Develop logical arguments and legal reasoning' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយអ្នកជំនាញច្បាប់ និងអតិថិជន' : 'Collaborate with legal professionals and clients' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ផ្តល់យោបល់ផ្នែកច្បាប់ប្រកបដោយប្រសិទ្ធភាព' : 'Communicate legal advice effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់ឧបករណ៍ និងមូលដ្ឋានទិន្នន័យសម្រាប់ការស្រាវជ្រាវផ្នែកច្បាប់' : 'Use legal research tools and databases' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'រៀបចំឯកសារ និងកិច្ចសន្យាផ្នែកច្បាប់' : 'Draft legal documents and contracts' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-gavel text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មេធាវី' : 'Lawyer' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-scale-balanced text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'ចៅក្រម' : 'Judge' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាច្បាប់' : 'Legal Advisor' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-balance-scale text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកចោទប្រកាន់' : 'Prosecutor' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវផ្នែកច្បាប់' : 'Legal Researcher' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកណែនាំផ្នែកច្បាប់ក្នុងក្រុមហ៊ុន' : 'Corporate Counsel' ?></p>
              </div>
            </div>
          </div>
        </section>
