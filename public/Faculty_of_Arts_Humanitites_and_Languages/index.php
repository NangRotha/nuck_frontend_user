...
<head>
  ...
  <title>NUCK | <?= $t('faculty_arts') ?> - National University of Cheasim Kamchaymear</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
        ...
        <div class="nav-menu-desktop">
          ...
          <div class="dropdown-container">
            ...
            <div class="dropdown-menu">
              ...
              <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="dropdown-item"><?= $t('faculty_arts') ?></a>
    ...
    <div class="space-y-1">
      ...
      <div class="mobile-nav-item">
        ...
        <div class="mobile-dropdown-content" id="academics">
          ...
          <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="mobile-dropdown-item"><?= $t('faculty_arts') ?></a>
  ...
  <!-- Faculty Header -->
  <div class="faculty-header" style="background-image: url('./../../images/ademices/art.jpg');">
    ...
    <div class="faculty-title-wrapper">
      ...
      <!-- <h2 class="text-xl md:text-2xl lg:text-3xl font-medium mb-4 faculty-title">
        <?= $lang->getCurrentLang() === 'km' ? 'មហាវិទ្យាល័យសិល្បៈ មនុស្សសាស្ត្រ និងភាសា' : 'Faculty of Arts, Humanities and Languages' ?>
      </h2> -->
  ...
  <div class="container-custom py-12">
    <!-- Khmer Literature Card -->
    <div class="program-card">
      <h2 class="program-title">
        <?= $lang->getCurrentLang() === 'km' ? 'អក្សរសាស្ត្រខ្មែរ' : 'Khmer Literature' ?>
      </h2>
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'អក្សរសាស្ត្រខ្មែរសិក្សាអំពីមរតកអក្សរសាស្ត្ររបស់កម្ពុជា ចាប់ពីស្នាដៃបែបប្រពៃណីដូចជា រាមកេរ្តិ៍ និង ទុំទាវ ដល់ស្នាដៃសម័យទំនើប។ និស្សិតយល់ដឹងអំពីវប្បធម៌ ប្រវត្តិសាស្ត្រ អត្តសញ្ញាណ ព្រមទាំងអភិវឌ្ឍការគិតវិភាគ និងការកោតសរសើរភាសាខ្មែរ និងសិល្បៈ។' : 'Khmer Literature explores Cambodia\'s rich literary heritage, from traditional works like Reamker and Tum Teav to modern writings. Students study themes of culture, history, and identity while developing critical thinking and appreciation for Khmer language and art.' ?>
      </p>
      <a href="./Khmer_Literature/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> 
      </a>
    </div>

    <!-- English for Education Card -->
    <div class="program-card">
      <h2 class="program-title">
        <?= $lang->getCurrentLang() === 'km' ? 'ភាសាអង់គ្លេសសម្រាប់ការអប់រំ' : 'English for Education' ?>
      </h2>
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីភាសាអង់គ្លេសសម្រាប់ការអប់រំផ្តោតលើការអភិវឌ្ឍជំនាញភាសាអង់គ្លេសកម្រិតខ្ពស់សម្រាប់បរិយាកាសសិក្សា និងវិជ្ជាជីវៈ។ និស្សិតនឹងរៀនអំពីការប្រាស្រ័យទាក់ទងប្រកបដោយប្រសិទ្ធភាព ការសរសេរបែបសិក្សា វិធីសាស្ត្រស្រាវជ្រាវ និងយុទ្ធសាស្ត្របង្រៀន។ កម្មវិធីនេះរៀបចំនិស្សិតសម្រាប់អាជីពក្នុងវិស័យអប់រំ ការបកប្រែ និងទំនាក់ទំនងអន្តរជាតិ។' : 'The English for Education program focuses on developing advanced English language skills tailored for academic and professional environments. Students will learn effective communication, academic writing, research methodologies, and teaching strategies. This program prepares graduates for careers in education, translation, and international communication.' ?>
      </p>
      <a href="./English_for_Education/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> 
      </a>
    </div>
  </div>
