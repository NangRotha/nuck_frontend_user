...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'អក្សរសាស្ត្រខ្មែរ' : 'Khmer Literature' ?> | Faculty of Arts, Humanities and Languages - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Khmer Literature Program -->
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'អក្សរសាស្ត្រខ្មែរ' : 'Khmer Literature' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Khmer Literature' : 'អក្សរសាស្ត្រខ្មែរ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រសិល្បៈផ្នែកអក្សរសាស្ត្រខ្មែរ' : 'Bachelor of Arts in Khmer Literature Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រសិល្បៈផ្នែកអក្សរសាស្ត្រខ្មែរមានគោលបំណងពង្រឹងការយល់ដឹងរបស់និស្សិតអំពីភាសា អក្សរសាស្ត្រ និងមរតកវប្បធម៌ខ្មែរ ដោយបញ្ចុះបញ្ចូលជំនាញវិភាគ អភិរក្ស និងផ្សព្វផ្សាយស្នាដៃអក្សរសាស្ត្រខ្មែរ។' : 'The Bachelor of Arts in Khmer Literature program aims to deepen students\' understanding of Khmer language, literature, and cultural heritage, equipping them with the skills to analyze, preserve, and promote Khmer literary works.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើអក្សរសាស្ត្របុរាណ អក្សរសាស្ត្រសម័យទំនើប វិភាគអក្សរសាស្ត្រ និងការនិពន្ធច្នៃប្រឌិត។' : 'This program focuses on classical literature, modern literature, literary analysis, and creative writing.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីប្រវត្តិ និងការវិវត្តនៃអក្សរសាស្ត្រខ្មែរ' : 'Understand the history and evolution of Khmer literature' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគស្នាដៃអក្សរសាស្ត្រខ្មែរបុរាណ និងសម័យទំនើប' : 'Analyze classical and modern Khmer literary works' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍការគិតវិភាគក្នុងការសិក្សាអក្សរសាស្ត្រ' : 'Develop critical thinking in literary analysis' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'បកស្រាយ និងវាយតម្លៃអត្ថន័យ និងរចនាបថអក្សរសាស្ត្រ' : 'Interpret and evaluate literary themes and styles' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការក្នុងការស្រាវជ្រាវ និងគម្រោងអក្សរសាស្ត្រ' : 'Collaborate in literary research and projects' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងគំនិតអក្សរសាស្ត្រយ៉ាងប្រសើរ' : 'Communicate literary ideas effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center">
                ...
                <?= $lang->getCurrentLang() === 'km' ? 'ជំនាញច្នៃប្រឌិត' : 'Creative Skills' ?>
              </h3>
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សរសេរ និងចងក្រងស្នាដៃអក្សរសាស្ត្រដើម' : 'Write and compose original literary works' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'បំរើអក្សរសាស្ត្រទៅជាមេឌៀផ្សេងៗ' : 'Adapt literary works into other media' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'គ្រូបង្រៀនអក្សរសាស្ត្រ' : 'Literature Teacher' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវផ្នែកអក្សរសាស្ត្រខ្មែរ' : 'Researcher in Khmer Studies' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-pen-fancy text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកនិពន្ធ' : 'Writer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកកែសម្រួល' : 'Editor' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-landmark text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីវប្បធម៌' : 'Cultural Officer' ?></p>
              </div>
            </div>
