...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'ភាសាអង់គ្លេសសម្រាប់ការអប់រំ' : 'English for Education' ?> | Faculty of Arts, Humanities and Languages - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - English for Education Program -->
  <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="container-custom">
      <!-- Back Link -->
      <div class="mb-6" data-aos="fade-right">
        <a href="./../../../public/Faculty_of_Arts_Humanitites_and_Languages/?lang=<?= $lang->getCurrentLang() ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
          <i class="fas fa-arrow-left mr-2"></i>
          <?= $lang->getCurrentLang() === 'km' ? 'ត្រឡប់ទៅមហាវិទ្យាល័យសិល្បៈ មនុស្សសាស្ត្រ និងភាសា' : 'Back to Faculty of Arts, Humanities and Languages' ?>
        </a>
      </div>
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'ភាសាអង់គ្លេសសម្រាប់ការអប់រំ' : 'English for Education' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'English for Education' : 'ភាសាអង់គ្លេសសម្រាប់ការអប់រំ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រសិល្បៈផ្នែកភាសាអង់គ្លេសសម្រាប់ការអប់រំ' : 'Bachelor of Arts in English for Education Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រសិល្បៈផ្នែកភាសាអង់គ្លេសសម្រាប់ការអប់រំត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ជំនាញភាសាអង់គ្លេសកម្រិតខ្ពស់ និងចំណេះដឹងផ្នែកគរុកោសល្យ ដើម្បីអនុញ្ញាតឱ្យនិស្សិតបង្រៀនភាសាអង់គ្លេសប្រកបដោយប្រសិទ្ធភាពក្នុងបរិយាកាសអប់រំផ្សេងៗ។' : 'The Bachelor of Arts in English for Education program is designed to equip students with advanced English language skills and pedagogical knowledge, enabling them to teach English effectively in diverse educational settings.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើភាសាវិទ្យា អក្សរសាស្ត្រអង់គ្លេស វិធីសាស្ត្របង្រៀន និងបច្ចេកវិទ្យាអប់រំ។' : 'This program focuses on linguistics, English literature, teaching methodology, and educational technology.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីរចនាសម្ព័ន្ធ និងការប្រើប្រាស់ភាសាអង់គ្លេស' : 'Understand English language structure and usage' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តទ្រឹស្តីគរុកោសល្យក្នុងការបង្រៀនភាសាអង់គ្លេស' : 'Apply pedagogical theories in teaching English' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគ និងប្តូរទម្រង់សម្ភារៈបង្រៀនសម្រាប់អ្នករៀនផ្សេងៗ' : 'Analyze and adapt teaching materials for diverse learners' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍការគិតវិភាគក្នុងការអប់រំភាសា' : 'Develop critical thinking in language education' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយក្រុមការងារក្នុងបរិយាកាសអប់រំ' : 'Collaborate with colleagues in educational settings' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងជាមួយនិស្សិត និងឪពុកម្តាយប្រកបដោយប្រសិទ្ធភាព' : 'Communicate effectively with students and parents' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center">
                ...
                <?= $lang->getCurrentLang() === 'km' ? 'ជំនាញផ្នែកបង្រៀន' : 'Teaching Skills' ?>
              </h3>
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'រៀបចំ និងអនុវត្តមេរៀនភាសាអង់គ្លេសប្រកបដោយប្រសិទ្ធភាព' : 'Design and deliver effective English lessons' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់បច្ចេកវិទ្យាដើម្បីពង្រឹងការរៀនភាសា' : 'Use technology to enhance language learning' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-chalkboard-teacher text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'គ្រូបង្រៀនភាសាអង់គ្លេស' : 'English Teacher' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-book-open text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកអភិវឌ្ឍកម្មវិធីសិក្សា' : 'Curriculum Developer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'គ្រូបណ្តុះបណ្តាលភាសា' : 'Language Trainer' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-handshake text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាផ្នែកអប់រំ' : 'Educational Consultant' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-language text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកបកប្រែ' : 'Translator' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវផ្នែកអប់រំភាសា' : 'Researcher in Language Education' ?></p>
              </div>
            </div>
          </div>
        </section>
