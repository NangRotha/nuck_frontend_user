...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'គណិតវិទ្យា' : 'Mathematics' ?> | Faculty of Science - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Mathematics Program (OLD UI STYLE) -->
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          ...
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Mathematics' : 'គណិតវិទ្យា' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកគណិតវិទ្យា' : 'Bachelor of Science in Mathematics Program' ?>
        </p>
      </div>

      <!-- Content Container - Simple White Card (OLD UI) -->
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកគណិតវិទ្យាត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ឱ្យនិស្សិតនូវមូលដ្ឋានគ្រឹះរឹងមាំក្នុងទ្រឹស្តី និងការអនុវត្តគណិតវិទ្យា ដើម្បីអនុញ្ញាតឱ្យពួកគេដោះស្រាយបញ្ហាស្មុគស្មាញក្នុងវិស័យផ្សេងៗ។' : 'The Bachelor of Science in Mathematics program is designed to provide students with a strong foundation in mathematical theory and applications, enabling them to solve complex problems in various fields.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើពិជគណិត កាល់គុល ស្ថិតិ និងគណិតវិទ្យាអនុវត្ត។' : 'This program focuses on algebra, calculus, statistics, and applied mathematics.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលគំនិតគណិតវិទ្យាមូលដ្ឋាន' : 'Understand fundamental mathematical concepts' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តទ្រឹស្តីគណិតវិទ្យាទៅលើបញ្ហាជាក់ស្តែង' : 'Apply mathematical theories to real-world problems' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគ និងដោះស្រាយបញ្ហាគណិតវិទ្យាស្មុគស្មាញ' : 'Analyze and solve complex mathematical problems' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍការគិតឡូជីខល និងការគិតវិភាគ' : 'Develop logical reasoning and critical thinking' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការប្រកបដោយប្រសិទ្ធភាពក្នុងគម្រោងក្រុម' : 'Collaborate effectively in group projects' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងគំនិតគណិតវិទ្យាយ៉ាងច្បាស់' : 'Communicate mathematical ideas clearly' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center">
                ...
                <?= $lang->getCurrentLang() === 'km' ? 'ជំនាញលេខ' : 'Numerical Skills' ?>
              </h3>
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តការគណនាលេខកម្រិតខ្ពស់' : 'Perform advanced numerical computations' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់កម្មវិធីគណិតវិទ្យា' : 'Use mathematical software tools' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-square-root-alt text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគណិតវិទ្យា' : 'Mathematician' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិភាគទិន្នន័យ' : 'Data Analyst' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគណនាហិរញ្ញវត្ថុ' : 'Actuary' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្ថិតិ' : 'Statistician' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិទ្យាសាស្ត្រស្រាវជ្រាវ' : 'Research Scientist' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'គ្រូបង្រៀនគណិតវិទ្យា' : 'Mathematics Teacher' ?></p>
              </div>
            </div>
          </div>
        </section>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        <div class="sm:col-span-2">
          <a href="./../../?lang=<?= $lang->getCurrentLang() ?>" class="inline-flex items-center gap-2 mb-4">
            ...
            <span class="text-lg font-bold text-white"><?= $lang->getCurrentLang() === 'km' ? 'សាកលវិទ្យាល័យជាតិជាស៊ីមកំចាយមារ' : 'National University of Cheasim Kamchaymear' ?></span>
          </a>
