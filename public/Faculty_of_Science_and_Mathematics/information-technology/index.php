...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'វិទ្យាសាស្រ្តកុំព្យូទ័រ' : 'Computer Science' ?> | Faculty of Science - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Computer Science Program -->
  <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="container-custom">
      <!-- Back Link -->
      <div class="mb-6" data-aos="fade-right">
        <a href="./../../../public/Faculty_of_Science_and_Mathematics/?lang=<?= $lang->getCurrentLang() ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
          <i class="fas fa-arrow-left mr-2"></i>
          <?= $lang->getCurrentLang() === 'km' ? 'ត្រឡប់ទៅមហាវិទ្យាល័យវិទ្យាសាស្ត្រ និងគណិតវិទ្យា' : 'Back to Faculty of Science & Mathematics' ?>
        </a>
      </div>
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          ...
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Computer Science' : 'វិទ្យាសាស្រ្តកុំព្យូទ័រ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកវិទ្យាសាស្រ្តកុំព្យូទ័រ' : 'Bachelor of Science in Computer Science Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកវិទ្យាសាស្រ្តកុំព្យូទ័រត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹង និងជំនាញដល់និស្សិតក្នុងផ្នែកគោលការណ៍វិទ្យាសាស្រ្តកុំព្យូទ័រ ការសរសេរកម្មវិធី ក្បួនដោះស្រាយ និងការអភិវឌ្ឍកម្មវិធី ដើម្បីអនុញ្ញាតឱ្យពួកគេដោះស្រាយបញ្ហាស្មុគស្មាញ និងចូលរួមចំណែកក្នុងការអភិវឌ្ឍបច្ចេកវិទ្យា។' : 'The Bachelor of Science in Computer Science program is designed to provide students with a strong foundation in computer science principles, programming, algorithms, and software development, enabling them to solve complex problems and contribute to technological advancements.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើការអភិវឌ្ឍកម្មវិធី បញ្ញាសិប្បនិម្មិត សន្តិសុខស៊ីប័រ និងការវិភាគទិន្នន័យធំ។' : 'This program focuses on software development, artificial intelligence, cybersecurity, and big data analytics.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលគំនិតជាមូលដ្ឋាននៃវិទ្យាសាស្រ្តកុំព្យូទ័រ' : 'Understand fundamental computer science concepts' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ស្ទាត់ជំនាញភាសាសរសេរកម្មវិធី និងក្បួនដោះស្រាយ' : 'Master programming languages and algorithms' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'រចនា និងវិភាគក្បួនដោះស្រាយដែលមានប្រសិទ្ធភាព' : 'Design and analyze efficient algorithms' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍ និងបង្កើនប្រសិទ្ធភាពប្រព័ន្ធកម្មវិធី' : 'Develop and optimize software systems' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការប្រកបដោយប្រសិទ្ធភាពក្នុងគម្រោងក្រុម' : 'Collaborate effectively in team projects' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងគំនិតបច្ចេកទេសយ៉ាងច្បាស់' : 'Communicate technical ideas clearly' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តគោលគំនិតគណិតវិទ្យាដើម្បីដោះស្រាយបញ្ហា' : 'Apply mathematical concepts to solve problems' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់ឧបករណ៍គណនាយ៉ាងមានប្រសិទ្ធភាព' : 'Utilize computational tools effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center">
                <span class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm mr-2">E</span>
                <?= $lang->getCurrentLang() === 'km' ? 'ជំនាញអនុវត្ត' : 'Psychomotor Skills' ?>
              </h3>
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្ត និងកែកំហុសកម្មវិធីកុំព្យូទ័រ' : 'Implement and debug software applications' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកអភិវឌ្ឍកម្មវិធី' : 'Software Developer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិទ្យាសាស្ត្រ​ទិន្នន័យ' : 'Data Scientist' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-sitemap text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិភាគប្រព័ន្ធ' : 'Systems Analyst' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-robot text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'វិស្វករបញ្ញាសិប្បនិម្មិត' : 'AI Engineer' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-globe text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកអភិវឌ្ឍគេហទំព័រ' : 'Web Developer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវវិទ្យាសាស្រ្តកុំព្យូទ័រ' : 'Computer Science Researcher' ?></p>
              </div>
            </div>
          </div>
        </section>
