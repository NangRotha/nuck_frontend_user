...
<head>
  ...
  <title><?= $t('about_message_rector') ?> | National University of Cheasim Kamchaymear</title>
      ...
      <div class="flex justify-between items-center h-[70px] lg:h-20">
        ...
        <div class="nav-menu-desktop">
          ...
          <div class="dropdown-container">
            ...
            <div class="dropdown-menu">
              <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="dropdown-item"><?= $t('about_message_rector') ?></a>
    ...
    <div class="space-y-1">
      ...
      <div class="mobile-nav-item">
        ...
        <div class="mobile-dropdown-content" id="about">
          <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="mobile-dropdown-item"><?= $t('about_message_rector') ?></a>
  ...
  <section class="py-12 sm:py-16 lg:py-20">
    <div class="container-custom">
      ...
      <div class="mb-8" data-aos="fade-right">
        <a href="./../../?lang=<?= $lang->getCurrentLang() ?>"
          ...
          <?= $lang->getCurrentLang() === 'km' ? 'ត្រឡប់ទៅទំព័រដើម' : 'Back to Home' ?>
        </a>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
        ...
        <div class="space-y-6" data-aos="fade-right">
          <div class="message-badge animate-fade-in-up">
            <i class="fas fa-envelope-open-text mr-2"></i>
            <?= $lang->getCurrentLang() === 'km' ? 'សារពីសាកលវិទ្យាធិការ' : 'MESSAGE FROM THE RECTOR' ?>
          </div>

          <div class="space-y-6 text-gray-700 dark:text-gray-300">
            <p class="text-lg leading-relaxed animate-fade-in-up delay-1">
              <?= $lang->getCurrentLang() === 'km' ? $t('about_text_1') : $t('about_text_1') ?>
            </p>

            <p class="text-lg leading-relaxed">
              <?= $lang->getCurrentLang() === 'km' ? $t('about_text_2') : $t('about_text_2') ?>
            </p>

            <p class="text-lg leading-relaxed animate-fade-in-up delay-2">
              <?= $lang->getCurrentLang() === 'km' ? 'សាកលវិទ្យាល័យជាតិជាស៊ីមកំចាយមារ មានមោទនភាពចំពោះនិស្សិតបញ្ចប់ការសិក្សារបស់ខ្លួនដែលបានបញ្ចប់ការសិក្សា ហើយបានក្លាយជាអ្នកដឹកនាំក្នុងវិស័យផ្សេងៗ ឬជាអ្នកច្នៃប្រឌិតក្នុងវិស័យអាជីវកម្ម។ ការចូលរួមរបស់សាស្ត្រាចារ្យដែលមានបទពិសោធន៍ និងធនធានបច្ចេកទេសទំនើបបានបង្កើតបរិយាកាសសិក្សាដ៏ល្អឥតខ្ចោះ។' : 'The National University of CheaSim Kamchaymear takes pride in its graduates who have completed their studies and become leaders in various fields or innovators in the business sector. The involvement of experienced faculty and modern technical resources has created an excellent learning environment.' ?>
            </p>
          </div>

          <!-- Rector Signature Card -->
          <div class="rector-card mt-8 animate-fade-in-up delay-3">
            <div class="relative z-10">
              <div class="rector-name">Prof. Seth Khan</div>
              <div class="rector-title"><?= $lang->getCurrentLang() === 'km' ? 'សាកលវិទ្យាធិការ និងព្រឹទ្ធបុរស' : 'Rector & Academic Dean' ?></div>
              <div class="signature-line"></div>
              <div class="rector-university"><?= $lang->getCurrentLang() === 'km' ? 'សាកលវិទ្យាល័យជាតិជាស៊ីមកំចាយមារ' : 'National University of CheaSim Kamchaymear' ?></div>
            </div>
          </div>
        </div>
        ...
        <div class="relative order-first lg:order-last" data-aos="fade-left">
          <div class="relative aspect-[3/4] overflow-hidden rounded-2xl shadow-2xl border-8 border-white dark:border-gray-800">
            <div class="absolute inset-0 bg-gradient-to-t from-primary-900/40 to-transparent z-10"></div>
            <img src="./../../images/about/RECTOR.png" alt="Rector Prof. Seth Khan" class="w-full h-full object-cover" loading="lazy" />
            <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent z-20">
              <div class="text-white">
                <p class="text-2xl font-bold">Prof. Seth Khan</p>
                <p class="text-sm opacity-90"><?= $lang->getCurrentLang() === 'km' ? 'សាកលវិទ្យាធិការនៃសាកលវិទ្យាល័យជាតិជាស៊ីមកំចាយមារ' : 'Rector of National University of Cheasim Kamchaymear' ?></p>
              </div>
            </div>
          </div>
