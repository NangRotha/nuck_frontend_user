...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'គណនេយ្យ' : 'Accounting' ?> | Faculty of Management - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Accounting Program -->
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'គណនេយ្យ' : 'Accounting' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Accounting' : 'គណនេយ្យ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកគណនេយ្យ' : 'Bachelor of Science in Accounting Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកគណនេយ្យ ត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹង និងជំនាញដល់និស្សិតក្នុងការគ្រប់គ្រងកំណត់ត្រាហិរញ្ញវត្ថុ វិភាគទិន្នន័យហិរញ្ញវត្ថុ និងធានាការអនុវត្តតាមស្តង់ដារ និងបទប្បញ្ញត្តិគណនេយ្យ។' : 'The Bachelor of Science in Accounting program aims to equip students with the knowledge and skills to manage financial records, analyze financial data, and ensure compliance with accounting standards and regulations.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើគណនេយ្យហិរញ្ញវត្ថុ គណនេយ្យគ្រប់គ្រង សវនកម្ម និងការបង់ពន្ធ។' : 'This program focuses on financial accounting, managerial accounting, auditing, and taxation.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលការណ៍ និងស្តង់ដារគណនេយ្យ' : 'Understand accounting principles and standards' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តបច្ចេកទេសរាយការណ៍ និងវិភាគហិរញ្ញវត្ថុ' : 'Apply financial reporting and analysis techniques' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគរបាយការណ៍ហិរញ្ញវត្ថុ និងការសម្តែង' : 'Analyze financial statements and performance' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ដោះស្រាយបញ្ហាគណនេយ្យស្មុគស្មាញ' : 'Solve complex accounting problems' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយអ្នកត្រួតពិនិត្យ និងអ្នកជំនាញហិរញ្ញវត្ថុ' : 'Collaborate with auditors and financial professionals' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងព័ត៌មានហិរញ្ញវត្ថុប្រកបដោយប្រសិទ្ធភាព' : 'Communicate financial information effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់កម្មវិធី និងឧបករណ៍គណនេយ្យ' : 'Use accounting software and tools' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តប្រព័ន្ធត្រួតពិនិត្យខាងក្នុង និងសវនកម្ម' : 'Implement internal control and auditing systems' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'គណនេយ្យករ' : 'Accountant' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-search text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'សវនករ' : 'Auditor' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាពន្ធ' : 'Tax Consultant' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិភាគថវិកា' : 'Budget Analyst' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីហិរញ្ញវត្ថុប្រតិបត្តិ' : 'Chief Financial Officer (CFO)' ?></p>
              </div>
            </div>
          </div>
        </section>
