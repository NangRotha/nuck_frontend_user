...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'ធនាគារនិងហិរញ្ញវត្ថុ' : 'Banking and Finance' ?> | Faculty of Management - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Banking and Finance Program -->
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'ធនាគារនិងហិរញ្ញវត្ថុ' : 'Banking and Finance' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Banking and Finance' : 'ធនាគារនិងហិរញ្ញវត្ថុ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកធនាគារ និងហិរញ្ញវត្ថុ' : 'Bachelor of Science in Banking and Finance Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកធនាគារ និងហិរញ្ញវត្ថុ ត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹង និងជំនាញដល់និស្សិតក្នុងការគ្រប់គ្រងប្រព័ន្ធហិរញ្ញវត្ថុ វិភាគទីផ្សារហិរញ្ញវត្ថុ និងធ្វើការសម្រេចចិត្តដោយយល់ដឹងក្នុងវិស័យធនាគារ និងការវិនិយោគ។' : 'The Bachelor of Science in Banking and Finance program aims to equip students with the knowledge and skills to manage financial systems, analyze financial markets, and make informed decisions in banking and investment sectors.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើការគ្រប់គ្រងហិរញ្ញវត្ថុ ការវិភាគការវិនិយោគ ការគ្រប់គ្រងហានិភ័យ និងទីផ្សារហិរញ្ញវត្ថុ។' : 'This program focuses on financial management, investment analysis, risk management, and financial markets.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីប្រព័ន្ធហិរញ្ញវត្ថុ និងប្រតិបត្តិការធនាគារ' : 'Understand financial systems and banking operations' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តការវិភាគហិរញ្ញវត្ថុ និងយុទ្ធសាស្ត្រវិនិយោគ' : 'Apply financial analysis and investment strategies' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគទីផ្សារហិរញ្ញវត្ថុ និងគន្លឹះសេដ្ឋកិច្ច' : 'Analyze financial markets and economic trends' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វាយតម្លៃហានិភ័យ និងផលចំណេញក្នុងការសម្រេចចិត្តវិនិយោគ' : 'Evaluate risks and returns in investment decisions' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយអ្នកជំនាញហិរញ្ញវត្ថុ និងភាគីពាក់ព័ន្ធ' : 'Collaborate with financial professionals and stakeholders' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងចំណេះដឹងហិរញ្ញវត្ថុប្រកបដោយប្រសិទ្ធភាព' : 'Communicate financial insights effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់ឧបករណ៍គំរូ និងការវិភាគហិរញ្ញវត្ថុ' : 'Use financial modeling and analysis tools' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តការគ្រប់គ្រងហានិភ័យ និងយុទ្ធសាស្ត្រផលិតផល' : 'Implement risk management and portfolio strategies' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីធនាគារ' : 'Banker' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិភាគហិរញ្ញវត្ថុ' : 'Financial Analyst' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-chart-pie text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងការវិនិយោគ' : 'Investment Manager' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងហានិភ័យ' : 'Risk Manager' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងផលិតផល' : 'Portfolio Manager' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាហិរញ្ញវត្ថុ' : 'Financial Consultant' ?></p>
              </div>
            </div>
          </div>
        </section>
