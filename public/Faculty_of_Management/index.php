...
<head>
  ...
  <title>NUCK | <?= $t('faculty_management') ?> - National University of Cheasim Kamchaymear</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
        ...
        <div class="nav-menu-desktop">
          ...
          <div class="dropdown-container">
            ...
            <div class="dropdown-menu">
              ...
              <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="dropdown-item"><?= $t('faculty_management') ?></a>
            </div>
          </div>
    ...
    <div class="space-y-1">
      ...
      <div class="mobile-nav-item">
        ...
        <div class="mobile-dropdown-content" id="academics">
          ...
          <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="mobile-dropdown-item"><?= $t('faculty_management') ?></a>
        </div>
      </div>
  ...
  <!-- Faculty Header -->
  <div class="faculty-header" style="background-image: url('./../../images/ademices/management.jpg');">
    ...
    <div class="faculty-title-wrapper">
      ...
      <!-- <h2 class="text-xl md:text-2xl lg:text-3xl font-medium mb-4 faculty-title">
        <?= $lang->getCurrentLang() === 'km' ? 'មហាវិទ្យាល័យគ្រប់គ្រង' : 'Faculty of Management' ?>
      </h2> -->
  ...
  <div class="container-custom py-12">
    ...
    <div class="program-card" data-aos="fade-up">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'គណនេយ្យផ្តោតលើការកត់ត្រា ការរាយការណ៍ និងការវិភាគប្រតិបត្តិការហិរញ្ញវត្ថុដោយមានប្រព័ន្ធ។ និស្សិតរៀនអំពីរបាយការណ៍ហិរញ្ញវត្ថុ ការត្រួតពិនិត្យ ពន្ធ និងគណនេយ្យគ្រប់គ្រង ដើម្បីគាំទ្រការសម្រេចចិត្តក្នុងអាជីវកម្ម និងអង្គការ។' : 'Accounting focuses on the systematic recording, reporting, and analysis of financial transactions. Students learn about financial statements, auditing, taxation, and managerial accounting to support decision-making in businesses and organizations.' ?>
      </p>
      <a href="./Accounting/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> 
      </a>
    </div>
    
    <!-- Banking and Finance Card -->
    <div class="program-card" data-aos="fade-up" data-aos-delay="100">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'ធនាគារនិងហិរញ្ញវត្ថុផ្តោតលើការគ្រប់គ្រងលុយ ការវិនិយោគ និងប្រព័ន្ធហិរញ្ញវត្ថុ។ និស្សិតសិក្សាអំពីទីផ្សារហិរញ្ញវត្ថុ ការគ្រប់គ្រងហានិភ័យ ហិរញ្ញវត្ថុក្រុមហ៊ុន និងប្រតិបត្តិការធនាគារ ដើម្បីត្រៀមខ្លួនសម្រាប់អាជីពក្នុងវិស័យហិរញ្ញវត្ថុ។' : 'Banking and Finance focuses on the management of money, investments, and financial systems. Students study financial markets, risk management, corporate finance, and banking operations to prepare for careers in the financial sector.' ?>
      </p>
      <a href="./Banking_and_Finance/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> 
      </a>
    </div>
    ...
    <div class="program-card" data-aos="fade-up" data-aos-delay="200">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'ទីផ្សារផ្តោតលើការយល់ដឹងអំពីអាកប្បកិរិយាអ្នកប្រើប្រាស់ ការបង្កើតតម្លៃ និងការផ្សព្វផ្សាយផលិតផល ឬសេវាកម្ម។ និស្សិតរៀនអំពីការស្រាវជ្រាវទីផ្សារ ម៉ាក ឌីជីថលទីផ្សារ និងយុទ្ធសាស្ត្រលក់ដើម្បីជំរុញការលូតលាស់អាជីវកម្ម។' : 'Marketing focuses on understanding consumer behavior, creating value, and promoting products or services. Students learn about market research, branding, digital marketing, and sales strategies to drive business growth.' ?>
      </p>
      <a href="./Marketing/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> 
      </a>
    </div>
    ...
    <div class="program-card" data-aos="fade-up" data-aos-delay="300">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' ? 'គ្រប់គ្រងធនធានមនុស្សផ្តោតលើការជ្រើសរើស ការបណ្តុះបណ្តាល និងការគ្រប់គ្រងបុគ្គលិកដើម្បីសម្រេចគោលបំណងរបស់អង្គការ។ និស្សិតសិក្សាអំពីការរៀបចំកម្លាំងពលកម្ម ទំនាក់ទំនងបុគ្គលិក ការគ្រប់គ្រងការសម្តែង និងអាកប្បកិរិយាអង្គការ។' : 'Human Resources Management focuses on recruiting, training, and managing employees to achieve organizational goals. Students study workforce planning, employee relations, performance management, and organizational behavior.' ?>
      </p>
      <a href="./Human_Resources_Management/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> 
      </a>
    </div>
  </div>
