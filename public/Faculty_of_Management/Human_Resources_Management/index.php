...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'គ្រប់គ្រងធនធានមនុស្ស' : 'Human Resources Management' ?> | Faculty of Management - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Human Resources Management Program -->
  <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="container-custom">
      <!-- Back Link -->
      <div class="mb-6" data-aos="fade-right">
        <a href="./../../../public/Faculty_of_Management/?lang=<?= $lang->getCurrentLang() ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
          <i class="fas fa-arrow-left mr-2"></i>
          <?= $lang->getCurrentLang() === 'km' ? 'ត្រឡប់ទៅមហាវិទ្យាល័យគ្រប់គ្រង' : 'Back to Faculty of Management' ?>
        </a>
      </div>
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'គ្រប់គ្រងធនធានមនុស្ស' : 'Human Resources Management' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'HR Management' : 'គ្រប់គ្រងធនធានមនុស្ស' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកគ្រប់គ្រងធនធានមនុស្ស' : 'Bachelor of Science in Human Resources Management Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកគ្រប់គ្រងធនធានមនុស្ស ត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹង និងជំនាញដល់និស្សិតក្នុងការគ្រប់គ្រង និងអភិវឌ្ឍកម្លាំងពលកម្មរបស់អង្គការ ដោយធានាការជ្រើសរើស ការបណ្តុះបណ្តាល និងទំនាក់ទំនងបុគ្គលិកប្រកបដោយប្រសិទ្ធភាព។' : 'The Bachelor of Science in Human Resources Management program aims to equip students with the knowledge and skills to manage and develop an organization\'s workforce, ensuring effective recruitment, training, and employee relations.' ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីនេះផ្តោតលើការជ្រើសរើសបុគ្គលិក ការគ្រប់គ្រងក និងការអភិវឌ្ឍន៍។' : 'This program focuses on talent acquisition, performance management, and development.' ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលការណ៍គ្រប់គ្រងធនធានមនុស្ស និងអាកប្បកិរិយាអង្គការ' : 'Understand HR principles and organizational behavior' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តយុទ្ធសាស្ត្រជ្រើសរើស និងគ្រប់គ្រងសមត្ថភាព' : 'Apply recruitment and talent management strategies' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគតម្រូវការកម្លាំងពលកម្ម និងសូចនាករការសម្តែង' : 'Analyze workforce needs and performance metrics' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍយុទ្ធសាស្ត្រចូលរួម និងការរក្សាបុគ្គលិក' : 'Develop employee engagement and retention strategies' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយក្រុមធនធានមនុស្ស និងអ្នកដឹកនាំអង្គការ' : 'Collaborate with HR teams and organizational leaders' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងគោលនយោបាយ និងការអនុវត្តធនធានមនុស្សប្រកបដោយប្រសិទ្ធភាព' : 'Communicate HR policies and practices effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់កម្មវិធី និងឧបករណ៍គ្រប់គ្រងធនធានមនុស្ស' : 'Use HR management software and tools' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តកម្មវិធីប៉ាន់ប្រមាណការសម្តែង និងការបណ្តុះបណ្តាល' : 'Implement performance evaluation and training programs' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងធនធានមនុស្ស' : 'HR Manager' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-user-plus text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកជំនាញជ្រើសរើសបុគ្គលិក' : 'Recruitment Specialist' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងការបណ្តុះបណ្តាល និងអភិវឌ្ឍន៍' : 'Training and Development Manager' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីទំនាក់ទំនងបុគ្គលិក' : 'Employee Relations Officer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកវិភាគប្រាក់ឈ្នួល និងអត្ថប្រយោជន៍' : 'Compensation and Benefits Analyst' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាអភិវឌ្ឍន៍អង្គការ' : 'Organizational Development Consultant' ?></p>
              </div>
            </div>
          </div>
        </section>
