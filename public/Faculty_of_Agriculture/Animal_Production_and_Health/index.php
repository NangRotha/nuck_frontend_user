...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'ផលិតកម្មសត្វ និងសុខភាពសត្វ' : 'Animal Production and Health' ?> | Faculty of Agriculture - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Animal Production and Health Program -->
  <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="container-custom">
      <!-- Back Link -->
      <div class="mb-6" data-aos="fade-right">
        <a href="./../../../public/Faculty_of_Agriculture/?lang=<?= $lang->getCurrentLang() ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
          <i class="fas fa-arrow-left mr-2"></i>
          <?= $lang->getCurrentLang() === 'km' ? 'ត្រឡប់ទៅមហាវិទ្យាល័យកសិកម្ម' : 'Back to Faculty of Agriculture' ?>
        </a>
      </div>
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'ផលិតកម្មសត្វ និងសុខភាពសត្វ' : 'Animal Production and Health' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Animal Production and Health' : 'ផលិតកម្មសត្វ និងសុខភាពសត្វ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកផលិតកម្មសត្វ និងសុខភាពសត្វ' : 'Bachelor of Science in Animal Production and Health Program' ?>
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 space-y-8" data-aos="fade-up">
        ...
        <section>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 
                'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកផលិតកម្មសត្វ និងសុខភាពសត្វ ត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹង និងជំនាញដល់និស្សិតដើម្បីកែលម្អផលិតភាពសត្វចិញ្ចឹម ធានាសុខភាពសត្វ និងជំរុញការអនុវត្តកសិកម្មសត្វដោយប្រកបដោយនិរន្តរភាព។' : 
                'The Bachelor of Science in Animal Production and Health program aims to equip students with the knowledge and skills to improve livestock productivity, ensure animal health, and promote sustainable animal farming practices.'
              ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 
                'កម្មវិធីនេះផ្តោតលើអាហារូបត្ថម្ភសត្វ ការបង្កាត់ពូជ សុខភាពសត្វ និងការគ្រប់គ្រងកសិដ្ឋាន។' : 
                'This program focuses on animal nutrition, breeding, animal health, and farm management.'
              ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលការណ៍អាហារូបត្ថម្ភសត្វ និងការបង្កាត់ពូជ' : 'Understand principles of animal nutrition and breeding' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តការគ្រប់គ្រងសុខភាពសត្វ' : 'Apply animal health management practices' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគ និងដោះស្រាយបញ្ហាផលិតកម្មសត្វ' : 'Analyze and solve animal production challenges' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍបច្ចេកទេសចិញ្ចឹមសត្វថ្មីៗ' : 'Develop innovative animal farming techniques' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយកសិករ និងអ្នកជំនាញពេទ្យសត្វ' : 'Collaborate with farmers and veterinary professionals' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងចំណេះដឹងសុខភាពសត្វប្រកបដោយប្រសិទ្ធភាព' : 'Communicate animal health knowledge effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់ឧបករណ៍ទំនើបសម្រាប់ត្រួតពិនិត្យសុខភាពសត្វ' : 'Use modern tools for animal health monitoring' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តការអនុវត្តចិញ្ចឹមសត្វដោយប្រកបដោយនិរន្តរភាព' : 'Implement sustainable animal farming practices' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-tractor text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកជំនាញផលិតកម្មសត្វ' : 'Animal Production Specialist' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-heartbeat text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីពេទ្យសត្វ' : 'Veterinary Officer' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-warehouse text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងកសិដ្ឋានសត្វចិញ្ចឹម' : 'Livestock Farm Manager' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកប្រឹក្សាសុខភាពសត្វ' : 'Animal Health Consultant' ?></p>
              </div>
            </div>
            
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-egg text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកជំនាញអាហារូបត្ថម្ភសត្វ' : 'Animal Nutritionist' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវផ្នែកវិទ្យាសាស្ត្រសត្វ' : 'Researcher in Animal Science' ?></p>
              </div>
            </div>
          </div>
        </section>
