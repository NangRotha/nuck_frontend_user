...
?>
<!DOCTYPE html>
<html lang="<?= $lang->getCurrentLang() === 'en' ? 'en' : 'km' ?>" class="dark">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0">
  <title>NUCK | <?= $t('faculty_agriculture') ?> - National University of Cheasim Kamchaymear</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
        ...
        <div class="nav-menu-desktop">
          ...
          <div class="dropdown-container">
            ...
            <div class="dropdown-menu">
              ...
              <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="dropdown-item"><?= $t('faculty_agriculture') ?></a>
    ...
    <div class="space-y-1">
      ...
      <div class="mobile-nav-item">
        ...
        <div class="mobile-dropdown-content" id="academics">
          ...
          <a href="./?lang=<?= $lang->getCurrentLang() ?>" class="mobile-dropdown-item"><?= $t('faculty_agriculture') ?></a>
  ...
  <!-- Faculty Header -->
  <div class="faculty-header" style="background-image: url('./../../images/ademices/social.png');">
    ...
    <div class="faculty-title-wrapper">
      <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 faculty-title">
        <?= $t('faculty_agriculture') ?>
      </h1>
      <!-- <h2 class="text-xl md:text-2xl lg:text-3xl font-medium mb-4 faculty-title">
        <?= $lang->getCurrentLang() === 'km' ? 'មហាវិទ្យាល័យកសិកម្ម' : 'Faculty of Agriculture' ?>
      </h2> -->
  ...
  <div class="container-custom py-12">
    ...
    <div class="program-card">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' 
            ? 'កសិកម្មផ្តោតលើវិទ្យាសាស្ត្រ និងបច្ចេកវិទ្យាក្នុងការផលិត និងប្រើប្រាស់រុក្ខជាតិសម្រាប់អាហារ ឥន្ធនៈ សរសៃ និងការស្តារដី។ និស្សិតរៀនអំពីការគ្រប់គ្រងដី ការផលិតដំណាំ និងការអនុវត្តកសិកម្មប្រកបដោយនិរន្តរភាព ដើម្បីកែលម្អសុវត្ថិភាពអាហារ និងសុខភាពបរិស្ថាន។' 
            : 'Agronomy focuses on the science and technology of producing and using plants for food, fuel, fiber, and land restoration. Students learn about soil management, crop production, and sustainable agricultural practices to improve food security and environmental health.' ?>
      </p>
      <a href="./Agronomy/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?>
      </a>
    </div>

    <!-- Animal Production and Health Card -->
    <div class="program-card">
      <h2 class="program-title">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' 
            ? 'ផលិតកម្មសត្វ និងសុខភាពសត្វផ្តោតលើការបង្កាត់ ការគ្រប់គ្រង និងការថែទាំសត្វចិញ្ចឹម ដើម្បីធានាបាននូវផលិតភាព និងសុខភាពល្អប្រសើរ។ និស្សិតសិក្សាអំពីអាហារូបត្ថម្ភសត្វ ការការពារជំងឺ និងការអនុវត្តកសិកម្មប្រកបដោយនិរន្តរភាព ដើម្បីកែលម្អសុខភាពសត្វ និងផលិតកម្មកសិកម្ម។' 
            : 'Animal Production and Health focuses on the breeding, management, and care of livestock to ensure optimal productivity and health. Students study animal nutrition, disease prevention, and sustainable farming practices to improve animal welfare and agricultural output.' ?>
      </p>
      <a href="./Animal_Production_and_Health/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?>
      </a>
    </div>
    ...
    <div class="program-card">
      ...
      <p class="program-description">
        <?= $lang->getCurrentLang() === 'km' 
            ? 'បច្ចេកវិទ្យាអាហារផ្តោតលើការអនុវត្តវិទ្យាសាស្ត្រ និងវិស្វកម្មក្នុងការផលិត ការរក្សាទុក និងការចែកចាយអាហារ។ និស្សិតសិក្សាអំពីការបំពានអាហារ សុវត្ថិភាពអាហារ និងការច្នៃប្រឌិត ដើម្បីធានាបាននូវភាពអាចរកបាននៃអាហារមានសុវត្ថិភាព និងរកបានអាហារូបត្ថម្ភសម្រាប់អ្នកប្រើប្រាស់។' 
            : 'Food Technology focuses on the application of science and engineering to the production, preservation, and distribution of food. Students study food processing, safety, and innovation to ensure the availability of safe and nutritious food for consumers.' ?>
      </p>
      <a href="./Food_Technology/?lang=<?= $lang->getCurrentLang() ?>" class="program-link">
        <?= $t('read_more') ?> 
      </a>
    </div>
  </div>
