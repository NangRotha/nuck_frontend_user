...
<head>
  ...
  <title><?= $lang->getCurrentLang() === 'km' ? 'បច្ចេកវិទ្យាអាហារ' : 'Food Technology' ?> | Faculty of Agriculture - NUCK</title>
...
<body class="<?= $lang->getCurrentLang() === 'km' ? 'khmer-font' : '' ?>">
  ...
  <!-- Main Content - Food Technology Program -->
    ...
    <div class="container-custom">
      ...
      <div class="flex flex-col items-center mb-8 md:mb-12" data-aos="fade-up">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4 text-center">
          <?= $lang->getCurrentLang() === 'km' ? 'បច្ចេកវិទ្យាអាហារ' : 'Food Technology' ?> / 
          <span class="text-blue-600 dark:text-blue-400"><?= $lang->getCurrentLang() === 'km' ? 'Food Technology' : 'បច្ចេកវិទ្យាអាហារ' ?></span>
        </h1>
        <div class="w-24 h-1 bg-blue-600 mx-auto"></div>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4 text-center max-w-2xl">
          <?= $lang->getCurrentLang() === 'km' ? 'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកបច្ចេកវិទ្យាអាហារ' : 'Bachelor of Science in Food Technology Program' ?>
        </p>
      </div>
          ...
          <div class="space-y-3 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              <?= $lang->getCurrentLang() === 'km' ? 
                'កម្មវិធីបរិញ្ញាបត្រវិទ្យាសាស្ត្រផ្នែកបច្ចេកវិទ្យាអាហារ ត្រូវបានរៀបចំឡើងដើម្បីផ្តល់ចំណេះដឹង និងជំនាញដល់និស្សិតដើម្បីច្នៃប្រឌិត និងកែលម្អផលិតកម្ម ការដំណើរការ និងសុវត្ថិភាពអាហារ ដោយធានាប្រព័ន្ធអាហារដែលមានគុណភាពខ្ពស់ និងប្រកបដោយនិរន្តរភាព។' : 
                'The Bachelor of Science in Food Technology program aims to equip students with the knowledge and skills to innovate and improve food production, processing, and safety, ensuring high-quality and sustainable food systems.'
              ?>
            </p>
            <p class="text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4 py-2 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
              <?= $lang->getCurrentLang() === 'km' ? 
                'កម្មវិធីនេះផ្តោតលើវិទ្យាសាស្ត្រអាហារ ការដំណើរការអាហារ សុវត្ថិភាពអាហារ និងការអភិវឌ្ឍន៍ផលិតផល។' : 
                'This program focuses on food science, food processing, food safety, and product development.'
              ?>
            </p>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  ...
                  <span><?= $lang->getCurrentLang() === 'km' ? 'យល់ពីគោលការណ៍វិទ្យាសាស្ត្រអាហារ និងបច្ចេកវិទ្យា' : 'Understand principles of food science and technology' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តស្តង់ដារសុវត្ថិភាព និងគុណភាពអាហារ' : 'Apply food safety and quality standards' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'វិភាគ និងដោះស្រាយបញ្ហាផលិតកម្មអាហារ' : 'Analyze and solve food production challenges' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អភិវឌ្ឍបច្ចេកទេសដំណើរការអាហារច្នៃប្រឌិត' : 'Develop innovative food processing techniques' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'សហការជាមួយអ្នកជំនាញក្នុងឧស្សាហកម្មអាហារ' : 'Collaborate with food industry professionals' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រាស្រ័យទាក់ទងការអនុវត្តសុវត្ថិភាព និងគុណភាពអាហារប្រកបដោយប្រសិទ្ធភាព' : 'Communicate food safety and quality practices effectively' ?></span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-5">
              ...
              <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'ប្រើប្រាស់បច្ចេកវិទ្យាទំនើបសម្រាប់ដំណើរការ និងរក្សាទុកអាហារ' : 'Use modern food processing and preservation technologies' ?></span>
                </li>
                <li class="flex items-start">
                  <i class="fas fa-check-circle text-green-500 mt-1 mr-2 flex-shrink-0"></i>
                  <span><?= $lang->getCurrentLang() === 'km' ? 'អនុវត្តប្រព័ន្ធត្រួតពិនិត្យគុណភាពក្នុងផលិតកម្មអាហារ' : 'Implement quality control systems in food production' ?></span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="career-item">
              <div class="flex items-center">
                <i class="fas fa-flask text-blue-600 mr-3 text-xl"></i>
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកបច្ចេកវិទ្យាអាហារ' : 'Food Technologist' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកគ្រប់គ្រងធានាគុណភាព' : 'Quality Assurance Manager' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'មន្ត្រីសុវត្ថិភាពអាហារ' : 'Food Safety Officer' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកជំនាញអភិវឌ្ឍន៍ផលិតផល' : 'Product Development Specialist' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'អ្នកស្រាវជ្រាវវិទ្យាសាស្ត្រអាហារ' : 'Research Scientist in Food Science' ?></p>
              </div>
            </div>
            ...
            <div class="career-item">
              <div class="flex items-center">
                ...
                <p class="text-gray-800 dark:text-white font-medium"><?= $lang->getCurrentLang() === 'km' ? 'វិស្វករដំណើរការអាហារ' : 'Food Processing Engineer' ?></p>
              </div>
            </div>
          </div>
        </section>
